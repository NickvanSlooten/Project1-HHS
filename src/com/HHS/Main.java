...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ex1.createQuestion("12.93 + 34.78 = ?", "Bereken de uitkomst van de som en schrijf het gehele antwoord op.", "47.71");
        ex1.createQuestion("999 - 789 = ?", "Bereken de uitkomst van de som en schrijf het gehele antwoord op.", "210");
        ...
        ex1.createQuestion("77.258 / 2 = ?", "Bereken de uitkomst van de som en rond je antwoord af op 2 decimalen. Tip: je mag een rekenmachine gebruiken.", "38.63");
        ex1.createQuestion("25(46/92) + 33(14/28) = ?", "Bereken de uitkomst van de som en schrijf het gehele antwoord op.", "59");
        ...
        ex2.createQuestion("Geef de header van de constructor voor de class Persoon.", "Tip: Denk aan de Stepik opdrachten.", "public Persoon () {}");
